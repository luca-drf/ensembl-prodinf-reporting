...
config = Config(
    ...
    reporter_type=os.environ.get('REPORTER_TYPE', file_config.get('reporter_type', 'elasticsearch')),
    ...
    amqp_prefetch=int(os.environ.get('AMQP_PREFETCH_COUNT', file_config.get('amqp_prefetch_count'))),
